...
标题: ".$message['message_title']."\r\n\r\n".$message['message_content'];
			...
			if(reMessage($_SESSION['kiwa_companyid'],$message['message_from'],$message['message_title'],$content,$_POST["rem_id"])){
				header('Location:'.APP_URL.'companypage/done/remessage_ok/');
			}else{

<?php
	if($_POST["people_title"]!=""&&$_POST["people_pr"]!=""&&$_POST["areaid"]!=""&&$_POST["pref"]!=""&&$_POST["kinds"]!=""&&$_POST["types"]!=""&&$_POST["moneyid"]!=""&&$_POST["employid"]!=""&&$_POST["hopeid"]!=""){
		//求职信息
		...
		$smarty->assign('zj_eki', $_POST["zj_eki"]);
		...
		$smarty->display('Mypage/findjob_add_review.html');
	}else{
		//没有参数跳回注册页面

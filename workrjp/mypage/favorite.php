<?php
	...
	//每页显示几条;//得到当前是第几页;
  	...
  	$subPages = new SubPages($show_num,$all_nums,$pageCurrent,10,APP_URL."mypage/favorite/$id/?Which_Show=$ws&pages=");
	//-----------------分页处理完了----------------------
	...
	if(isMobile()){
		$smarty->display('mobile/Mypage/favorite.html');
	}else{
		$smarty->display('Mypage/favorite.html');
	}

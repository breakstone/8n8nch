	...
	if($photo){
		...
		if($photo["user_type"] == "company"){
			...
			if($company){
				...
				if(isMobile()){
					$smarty->display('mobile/People/company_photoshow.html');
				}else{
					$smarty->display('People/company_photoshow.html');
				}
			...
			if($user){
				...
				$smarty->assign('THEME', THEME);
				if(isMobile()){
					$smarty->display('mobile/People/people_photoshow.html');
				}else{
					$smarty->display('People/people_photoshow.html');
				}

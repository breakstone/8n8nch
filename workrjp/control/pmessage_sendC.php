<?php
	...
	//发表工作
	if(isset($_POST['message_from'])&&isset($_POST['message_to'])&&isset($_SESSION['kiwa_username'])&&isset($_SESSION['kiwa_userid'])){
		...
		if($return){
			//没有参数跳到错误页面
			header('Location:'.APP_URL.'mypage/done/message_send_ok/');
		}else{
			header('Location:'.APP_URL.'mypage/done/message_send_no/');
		}
	}else{
		//没有参数跳到错误页面

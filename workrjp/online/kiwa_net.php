<?php
	...
	if(isset($_POST["sendB"])){
		...
		$sql = "insert into dtb_online (user_id,name,pinyin,birth,sex,country,visa,tall,tizhong,shoenum,xuexing,tel,areaid,pref,line,eki,type,day,create_date,remark)values(
				'$user_id','$name','$pinyin','$birth','$sex','$country','$visa','$tall','$tizhong','$shoenum','$xuexing','$tel','$areaid','$pref','$line','$eki','kiwa_net','$day','$create_date','$remark')";		
	...
	if(isMobile()){
		$smarty->display('Online/kiwa_netmobile.html');
	}else{
		$smarty->display('Online/kiwa_net.html');
	}
?>
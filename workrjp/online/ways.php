<?php
	...
	if(isset($_POST["sendB"])){
		...
		$sql = "insert into dtb_online (user_id,name,pinyin,birth,sex,country,visa,tall,tizhong,shoenum,xuexing,tel,areaid,pref,line,eki,type,day,create_date)values(
				'$user_id','$name','$pinyin','$birth','$sex','$country','$visa','$tall','$tizhong','$shoenum','$xuexing','$tel','$areaid','$pref','$line','$eki','ways','$day','$create_date')";		
	...
	if(isMobile()){
		$smarty->display('Online/waysmobile.html');
	}else{
		$smarty->display('Online/ways.html');
	}
?>
...
public static function editor($textareaid = 'content', $toolbar = 'basic', $height = 200, $color = '', $up=true) {
	...
	public static function date($name, $value = '', $isdatetime = 0, $loadjs = 0) {
		...
		if($loadjs || !defined('CALENDAR_INIT')) {
			...
			$str .= '<script src="'.APP_URL.'/js/date/js/jscal2.js"></script>
   				 <script src="'.APP_URL.'/js/date/js/lang/cn.js"></script>
   				 <link rel="stylesheet" type="text/css" href="'.APP_URL.'/js/date/css/jscal2.css" />
    				<link rel="stylesheet" type="text/css" href="'.APP_URL.'/js/date/css/border-radius.css" />
    				<link rel="stylesheet" type="text/css" href="'.APP_URL.'/js/date/css/steel/steel.css" />';
		}
	...
	public static function color($name, $value = '000000') {
		...
		if(!defined('COLOR_INIT')) {
			define('COLOR_INIT', 1);
			$str= '<script src="'.APP_URL.'/js/jscolor/jscolor.js"></script>';

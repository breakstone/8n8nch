...
//---------------检索按钮点击后进入页面---------------------------------//
	...
	//每页显示几条;//得到当前是第几页;
  	...
  	$subPages = new SubPages($show_num,$all_nums,$pageCurrent,10,APP_URL."job/msearch/?search=true&keyword=$keyword&kinds=$kinds&types_url=$types_url&service_id=$service_id&areaid=$areaid&pref=$pref&ensn_url=$ensn_url&eki_url=$eki_url&moneyid=$moneyid&employid_url=$employid_url&hopeid_url=$hopeid_url&shok3_str=$shok3_str&biaoname=$biaoname&page=");
	//-----------------分页处理完了----------------------
	...
	$smarty->display('mobile/Job/msearch.html');
